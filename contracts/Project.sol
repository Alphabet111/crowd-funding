...
contract Project {
    ...
    constructor(string memory _description, uint _minInvest, uint _maxInvest, uint _goal, address _owner) public {
        owner = _owner;
    ...
    function createPayment(string memory _description, uint _amount, address _receiver) ownerOnly public {
    ...
    function doPayment(uint index) ownerOnly public payable {
        Payment storage payment = payments[index];
